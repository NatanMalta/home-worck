 ...
 * @author admin
 */
public class frmMultiplicacao extends javax.swing.JDialog
{

    /**
     * Creates new form frmMultiplicacao
     */
    ...
    public frmMultiplicacao(java.awt.Frame parent, boolean modal)
    {
        super(parent, modal);
        initComponents();
        this.objControle = new ControleQuestoes(lblNumeroQuestao, lblNumeroSuperior, lblNumeroInferior, this, "*", 9999,9,true,false); 
    }
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(frmMultiplicacao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                frmMultiplicacao dialog = new frmMultiplicacao(new javax.swing.JFrame(), true);
